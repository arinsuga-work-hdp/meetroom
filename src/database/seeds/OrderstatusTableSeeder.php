...
class OrderstatusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table("orderstatus")->insert([ "id" => 2, "name" => "Close", "description" => "Close", "image" => null, "numsort" => 20, "status" => 1 ]);  
        DB::table("orderstatus")->insert([ "id" => 3, "name" => "Pending", "description" => "Pending", "image" => null, "numsort" => 30, "status" => 1 ]);  
